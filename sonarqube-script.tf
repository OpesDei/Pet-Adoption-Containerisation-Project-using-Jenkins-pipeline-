...
#Install New relic
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo  NEW_RELIC_API_KEY=NRJS-99dfcb510ed441a0009 NEW_RELIC_ACCOUNT_ID=3942598 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
